...
namespace Samples.Whisper
{
	public static class SaveWav
	{
		...
		public static byte[] Save(string filename, AudioClip clip)
		{
			...
			var filepath = "C: /Users/cave/Documents/Valentin Mikey projet/FYP - master/Whisper";//Path.Combine(Application.persistentDataPath, filename);
				//Debug.Log(filepath);//"C:\Users\cave\AppData\LocalLow\DefaultCompany\FYP"
